    ...
    const fetchBLData = async () => {
        try {
            ...
            setFormData({
                ...
                // 🔥 Si lugar_emision está vacío o es "NO ESPECIFICADO", usar el puerto_embarque
                lugar_emision: (bl.lugar_emision_cod && bl.lugar_emision_cod !== 'NO ESPECIFICADO')
                    ? bl.lugar_emision_cod
                    : (bl.puerto_embarque_cod || ""),
                // 🔥 Si lugar_recepcion está vacío o es "NO ESPECIFICADO", usar el puerto_embarque
                ...
                observaciones: bl.observaciones || ""
            });
    ...
    <div className="space-y-4">
        ...
        <div>
            ...
            <textarea
                ...
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0F2A44]"
                rows={2}
                placeholder="Observaciones adicionales del BL"
            />
        </div>
    </div>
);
